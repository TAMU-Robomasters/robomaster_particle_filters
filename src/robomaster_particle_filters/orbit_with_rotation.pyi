...
class ObservedPlate:
    def __init__(self, position: npt.NDArray[np.float64],
                 ...
                 rotation_diagonal_covariance: npt.NDArray[np.float64]): ...
    ...
    def rotation_diagonal_covariance(self) -> npt.NDArray[np.float64]: ...


class PredictedPlate:
    def __init__(
        self, position: npt.NDArray[np.float64], velocity: npt.NDArray[np.float64], roatation: npt.NDArray[np.float64], rotation_velocity: npt.NDArray[np.float64]): ...

    def position(self) -> npt.NDArray[np.float64]: ...
    def velocity(self) -> npt.NDArray[np.float64]: ...
    def rotation(self) -> npt.NDArray[np.float64]: ...
    def rotation_velocity(self) -> npt.NDArray[np.float64]: ...
